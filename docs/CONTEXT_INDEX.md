...
- [`docs/prompt/01-sdlc-playbook/`](prompt/01-sdlc-playbook/00-MASTER-AI-NATIVE-SDLC-PLAYBOOK.md): Chuỗi 14 prompt quy trình AI-Native SDLC toàn diện từ Khởi tạo đến Vận hành & Thực thi Coding Rules (Pha 00 - 13).
