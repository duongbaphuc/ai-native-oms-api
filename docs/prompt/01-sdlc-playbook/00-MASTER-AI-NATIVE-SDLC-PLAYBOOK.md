...
| **10** | [`10-docker-and-cicd-pipeline.prompt.md`](10-docker-and-cicd-pipeline.prompt.md) | Lead DevSecOps Architect & Cloud-Native Engineer | Đóng gói Multi-Stage Dockerfile (non-root), Docker Compose, GitHub Actions CI/CD và kiểm định 11 quy trình SDLC (Pha 05 - 15) | `docker build` thành công, `.github/workflows/ci.yml` kiểm định tự động 100% SDLC gates |
