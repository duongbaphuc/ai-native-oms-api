...
public interface OrderCsvProcessor {
    ...
    default OrderCalculationResult process(java.io.File inputFile, java.io.File outputFile) throws CsvVatException {
        java.util.Objects.requireNonNull(inputFile, "inputFile must not be null");
        java.util.Objects.requireNonNull(outputFile, "outputFile must not be null");
