...
| :--- | :---: | :---: | :---: | :---: |
| **`com.company.shared.csvvat`** | 68.9% ➔ **100%** *(613/613 instructions)* | 68.4% ➔ **100%** *(141/141 lines)* | 100% ➔ **100%** *(8/8 branches)* | **0** |
...
| **TOÀN DỰ ÁN (BUNDLE TOTAL)** | **84.9% ➔ 100%** *(2,985/2,985)* | **87.0% ➔ 100%** *(623/623 lines)* | **84.5% ➔ 95.5%** *(210/220 branches)* | **0 dòng sót** |
