...
- **Clean Code Layout & Spacing:** Bắt buộc có chính xác 1 dòng trống trước câu lệnh `return` trong mọi method hoặc khối mã lệnh có từ 2 câu lệnh trở lên (trừ single-line method/lambda).
